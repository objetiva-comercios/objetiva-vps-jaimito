...
- [x] **DASH-02**: Vista principal: tabla con todas las métricas (nombre, valor actual, sparkline de tendencia, indicador de estado)
- [x] **DASH-03**: Click en una fila expande un gráfico temporal (uPlot) con historial de esa métrica
- [x] **DASH-04**: Auto-refresh cada 30 segundos sin recargar la página (Alpine.js polling)
- [x] **DASH-05**: Frontend usa Tailwind CSS pre-compilado, Lucide icons inline SVG, Alpine.js, uPlot
- [x] **DASH-06**: El dashboard muestra hostname del VPS y timestamp de última actualización
